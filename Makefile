...
lint: ## check style with flake8
	flake8 chibi_dl tests

coverage: ## check code coverage quickly with the default Python
	coverage run --source chibi_dl setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/chibi_dl.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ chibi_dl
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pycodestyle --statistics chibi_dl tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes chibi_dl tests
